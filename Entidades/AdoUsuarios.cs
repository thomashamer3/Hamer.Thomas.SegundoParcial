...
namespace Entidades
{
    public class AdoUsuarios : ISelecionar<Usuarios>
    {
        #region Atributos
        ...
        static AdoUsuarios()
        {
            AdoUsuarios.cadenaConexion = @"Data source=.;initial catalog=Generala_Segundo_Parcial;integrated security=true";
        }

        public AdoUsuarios()
        {
            this.conexion = new SqlConnection(AdoUsuarios.cadenaConexion);
        }
